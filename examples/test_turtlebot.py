...
def main(floor_width=2.0):
    ...
    for i in range(10):
        ...
        center = [(x+y)/2. for x,y in zip(lower,upper)] #(lower + upper)/2. # Computing the center of the AABB        
        extent = [x-y for x,y in zip(upper,lower)] # Computing the dimensions of the AABB
